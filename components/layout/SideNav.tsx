...
export function SideNav() {
  ...
  return (
    <nav className="fixed top-1/2 right-4 z-70 hidden -translate-y-1/2 flex-col items-center gap-2.5 xl:flex">
      {SECTIONS.map(({ id, num }) => {
        ...
        return (
          <button
            ...
            className={`sidenav-dot ${isActive ? 'sidenav-dot--active' : ''} flex h-9 w-9 cursor-pointer items-center justify-center rounded-full text-xs font-bold transition-all duration-200`}
