...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="snap-section flex items-center bg-[#111]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <AnimatedText>
            ...
            <div className="space-y-8">
              ...
              <div>
                <p className="text-white/30 text-xs uppercase mb-3" style={{letterSpacing: '3px'}}>
                  {t('hotline_label')}
                </p>
                <a
                  href={`tel:${t('hotline').replace(/\s/g, '')}`}
                  className="text-[#FFB800] font-bold hover:text-white transition-colors"
              ...
              <div>
                ...
                <p className="text-white/60">{t('tax')}</p>
              </div>
              <div>
                <p className="text-white/30 text-xs uppercase mb-4" style={{letterSpacing: '3px'}}>
                  {t('follow')}
                </p>
                <div className="flex gap-6">
                  {[
                    ...
                    <a
                      ...
                      className="text-white/40 hover:text-[#FFB800] transition-colors font-bold"
          ...
          <AnimatedText delay={0.2}>
            <div
              ...
              style={{height: '480px', filter: 'grayscale(40%)'}}
            >
              <iframe
